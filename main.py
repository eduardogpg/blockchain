...
if __name__ == '__main__':
    ...
    transaction4 = Transaction(caroline.public_key, alice.public_key, 20)
    transaction5 = Transaction(caroline.public_key, alice.public_key, 20)

    blockchain.add_transacction(transaction1)
    blockchain.add_transacction(transaction2)
    blockchain.add_transacction(transaction3)
    blockchain.add_transacction(transaction4)
    blockchain.add_transacction(transaction5)
